...
class TestSegmenterBatchProcessing:
    ...
    def test_segment_mixed_batch_handles_different_languages(
    ...
    def test_segment_mixed_batch_preserves_order(self, segmenter: Segmenter):
    ...
    def test_segment_batch_unsupported_language(self, segmenter: Segmenter):
    ...
    def test_segment_batch_empty_list(self, segmenter: Segmenter):
...
class TestSegmenterModelLoading:
    ...
    def test_model_caching_by_model_name(self, segmenter: Segmenter):
        ...
        # Verify that the models are actually cached (not just loaded)
        # Loading the same models again should return the same objects
        model1_cached = segmenter._load_model("en")
        model2_cached = segmenter._load_model("es")
        assert model1 is model1_cached
        assert model2 is model2_cached

    def test_model_reuse_from_cache(self, segmenter: Segmenter):
        ...
        # Cache should have the English model
        assert "en_core_web_sm" in segmenter._models

        # Verify that the model is actually cached (not just loaded)
        # The model should be the same object when loaded again
        model3 = segmenter._load_model("en")
...
class TestSegmenterDocumentation:
    ...
    def test_segment_batch_docstring_warns_about_language(self, segmenter: Segmenter):
    ...
    def test_segment_mixed_batch_docstring_explains_usage(self, segmenter: Segmenter):
...
def test_segmenter_backward_compatibility(segmenter: Segmenter):
